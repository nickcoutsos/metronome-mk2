puredom.addNodeSelectionPlugin('touchslide', function(dragFactor, updateInterval, deadZone) {
    
    dragFactor     = dragFactor || 0.75;
    ...
    on_inertia = function(ne) {
        ...
        if (Math.abs(ne.deltaX) > deadZone ||
            Math.abs(ne.deltaY) > deadZone) {
